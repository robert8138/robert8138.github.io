...
### Try Focusing on 1 at a Time, Avoid Bigism
...
- **Translation 1:** Throughout the first 18 years of his career in the NBA, LeBron James scored over 35,000 points.
- **Translation 2:** Throughout the first 18 years of his career in the NBA, LeBron James scored an average of over 27 points per game.

Our temptation is to go for the staggering number. "Wow, that is big." 35,000 feels huge. 27 doesn't. At least not at first. This misconception is something we have labeled "big-ism." We are tempted to go for something bigger when what we really need is something with a size we can understand.
...
Which list did you remember better? If you said "List A," you probably forgot which was A. The second list is easier to deal with in every way: it's easier to understand, easier to retain, and easier to repeat. And the information it conveys is functionally the same. That new office that's 6 times bigger won't feel any less spacious if you find it's only 5.73 times bigger. And try telling someone who got only half as much pay for the same amount of work someone else did that they actually got 9/17ths as much. See if they feel better.
...
> Try making something concrete, and people will remember it.
...
- **Translation 1:** 40% of US adults do not always wash their hands after using the bathroom at home.
- **Translation 2:** 2 out of every 5 people you shake hands with haven't washed their hands after using the restroom.

### Make It Human Scale

> Concreteness is good, but a lot of time big numbers are hard to comprehend, and it's very useful to put them in human scale.
...
- **Translation 1:** The chance of dying from skydiving is 8 in a million.
- **Translation 2:** Pick the entire series of Harry Potter of 7 books, and mark 8 words with red crosses. If you hit any one of the words in the series, then you die. Look how small the chance is!

Taxes:

- Instead of talking millions, billions, and trillions of tax revenue and government expenses, why not switch dimensions? Talk about citizen's work weeks, days, hours.

## Better Motivate

### Tap Pools of Pre-existing Emotions

> Contextualize and help people to understand.

Cranberry juice:

- **Translation 1:** Cranberry juice has 44 grams of sugar.
- **Translation 2:** Cranberry juice is equivalent to 3 Dunkin donuts and 3 sugar cubes.

### Add Up Good Stuff

Teaching:

- **Translation 1:** For each class, you assign a "Do Now", you gain an extra 5 minutes of discussion time.
- **Translation 2:** Saving 5 minutes per class is equivalent to adding weeks to the school year. Think of how many cool demonstrations or interesting topics you can add with another 3 weeks to play with.
...
Now put on your most comfortable hiking shoes. You'd have to climb for almost 3 hours before reaching the net worth of a billionaire. After spending 9 hours a day climbing steps for 2 months, you'd have Ironman-level quads as you finally reach the wealth of Jeff Bezos.
...
Build your message so that there's a surprise at the end, perhaps using a category jumper mentioned above.
