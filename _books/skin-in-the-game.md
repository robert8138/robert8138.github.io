...
If you want to reap the benefit of a positive outcome, you also need to be willing to tolerate the negative outcome when things go wrong.

![Skin in the Game — figure 1]({{ "/images/books/skin-in-the-game-1.png" | prepend: site.baseurl }})

### Implications of Skin In the Game

- Allows the minority to rule over the majority
- Makes you smarter
- Turns employees into a dependable workforce

![Skin in the Game — figure 2]({{ "/images/books/skin-in-the-game-2.png" | prepend: site.baseurl }})

### Inequality v.s. Inequality

![Skin in the Game — figure 3]({{ "/images/books/skin-in-the-game-3.png" | prepend: site.baseurl }})
...
![Skin in the Game — figure 4]({{ "/images/books/skin-in-the-game-4.png" | prepend: site.baseurl }})
