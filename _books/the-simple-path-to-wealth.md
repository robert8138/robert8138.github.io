...
- **The simplest investment strategy:** Collins recommends Vanguard Total Stock Market Index Fund (VTSAX) as the ultimate "set it and forget it" investment. Why?
...
## ⌛ The Wealth-Building & Preservation Phases

### 🧱 1. Accumulation Phase (Wealth-Building)

- When you're working and saving.
...
> 🧠 Think: "I'm investing for decades. Market dips are buying opportunities."

### 🛡️ 2. Preservation Phase (Pre-Retirement & Retirement)

- When you're drawing down assets or preparing to do so.
...
| --- | --- |
| **Stocks** | VTSAX – Vanguard Total Stock Market Index Fund |
| **Bonds (optional)** | VBTLX – Vanguard Total Bond Market Index Fund |

### 🔢 Suggested Allocation by Life Stage

| Stage / Risk Profile | Stocks (VTSAX) | Bonds (VBTLX) |
| --- | --- | --- |
| Young (20s–30s), high risk | 100% | 0% |
| Moderate (30s–50s) | 80% | 20% |
| Pre-retirement (50s–60s) | 60–70% | 30–40% |
| Conservative / Retired | 50–60% | 40–50% |

> "If you can handle the volatility, 100% VTSAX is a fine choice."

### 🔁 Rebalancing Advice

- Rebalance **once a year** or when allocations drift **5–10%** off target.
- Prefer to rebalance using **new contributions**.
- Keep it simple — don't get stuck optimizing.
- During crashes, **stay the course** — do not panic sell.
...
### 📉 2. You Can't Predict the Market — Don't Try
...
> "Trying to time the market is the surest way to fail."

### 📈 3. Stocks Are Volatile — and That's Okay
...
### 🧾 4. Focus on the Total Stock Market

- **VTSAX** gives you exposure to the **entire U.S. market** — thousands of companies.
...
### 🏦 2. Types of Bonds and Tax Implications
...
> 🧠 Tip: Use Treasury or municipal bonds in taxable accounts, and corporate bonds in tax-advantaged accounts like IRAs.

### 📉 3. How Interest Rates and Inflation Affect Bond Prices

- **Rising interest rates** → Bond prices **fall**
- **Falling interest rates** → Bond prices **rise**
- **High inflation** → Reduces the **real return** on bonds

> 📌 Collins prefers short- to intermediate-term bonds to reduce sensitivity to interest rate changes.

### 💵 4. Credit Ratings and Risk
...
### 📈 5. Why Collins Recommends Vanguard Bond Funds

- **Broad diversification**
- **Low-cost and tax-efficient**
- Automatically reinvests interest
- Example: **VBTLX** — Vanguard Total Bond Market Index Fund
...
### 🏗️ Wealth Accumulation Phase (While You're Working & High Earner)
...
- ✅ Do a Mega Backdoor Roth IRA (if your plan allows)
  - Contribute **after-tax dollars** to your 401(k) beyond the $23K limit — up to the **$70,000 total limit** (includes employer match).
  - Immediately **convert to Roth 401(k)** (in-plan) or roll out to **Roth IRA** (outside plan).
  - Grows **100% tax-free** after conversion.
  - No income limits, no RMDs — **a top-tier wealth builder**.
- ✅ Then, funnel any extra savings into a **taxable brokerage account**
  - No contribution or income limits.
  - No early withdrawal penalties — full flexibility.
...
- 🔥 Optional: Roth Conversion Ladder for Early Retirement
  - Roll old 401(k) into Traditional IRA, then convert ~$40K–60K/year to Roth IRA.
  - Each conversion starts a **5-year clock**.
  - After 5 years, withdraw converted amounts **tax- and penalty-free**, even before 59½.
  - Build a tax-free income bridge from retirement to age 59½.

### 🛡️ Wealth Preservation Phase (Retirement / Post-FIRE)

- ✅ **Withdraw from taxable accounts first**, especially in early retirement when income is low
- ✅ Take advantage of the **0% capital gains tax bracket** — in 2025: $0–$47,025 taxable income = 0% LTCG (single)
- ✅ Preserve IRAs and Roths for later; let tax-deferred and tax-free accounts grow longer
- ✅ Use taxable withdrawals to **control your taxable income**, creating room for strategic Roth conversions or ACA subsidies
- ✅ Do **tax-loss harvesting** during downturns to reduce capital gains taxes
