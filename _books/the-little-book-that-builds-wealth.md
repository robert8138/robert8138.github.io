...
isbn: "9780470468388"
cover_id: "7915755"
one_liner: "Buy great companies at good prices and hold them for the long term — the moat is what makes them great."
read: 2021
---

<!-- Synced from Notion (Book Summary database). Notion is the source of truth. -->

<!-- Two blocks in the Notion page (a bookmark and an embedded tweet) could not be resolved by the API and are omitted. -->
...
1. Identify firms that have sustainable competitive advantages and are likely to be profitable year after year
2. Wait until their stock prices fall below their intrinsic value before buying them
3. Hold these stocks as long as they continue to meet your criteria
4. Consider selling if they no longer fit your definition of a great company

[Talk on the same material](https://www.youtube.com/watch?v=YFS5JBgz1Xc)
...
- [**Return on Assets (ROA)**](https://www.investopedia.com/terms/r/returnonassets.asp): an indicator of how profitable a company is relative to its total assets. ROA gives a manager, investor, or analyst an idea as to how efficient a company's management is at using its assets to generate earnings.
- [**Return on Equity (ROE)**](https://www.investopedia.com/terms/r/returnonequity.asp): a measure of financial performance calculated by dividing net income by shareholders' equity. Because shareholders' equity is equal to a company's assets minus its debt, ROE is considered the return on net assets.
- [**Return on Invested Capital (ROIC)**](https://www.investopedia.com/terms/r/returnoninvestmentcapital.asp): a calculation used to assess a company's efficiency at allocating the capital under its control to profitable investments.
...
- [**Price-to-Sales (P/S Ratio)**](https://www.investopedia.com/terms/p/price-to-salesratio.asp): calculated by dividing the company's market capitalization by its total sales over a designated period (usually twelve months). Most useful for companies that have temporarily depressed margins.
- [**Price-to-Book (P/B Ratio)**](https://www.investopedia.com/terms/p/price-to-bookratio.asp): compares a firm's market capitalization to its book value. It's calculated by dividing the company's stock price per share by its book value per share (BVPS). Extremely useful for valuing financial services companies.
- [**Price-to-Earnings (P/E Ratio)**](https://www.investopedia.com/terms/p/price-earningsratio.asp): measures its current share price relative to its per-share earnings (EPS). Look at how a company's P/E has fared in good times and bad and think about how the company's future looks.
- [**Price-to-Cash Flow (P/CF Ratio)**](https://www.investopedia.com/terms/p/price-to-cash-flowratio.asp): measures the value of a stock's price relative to its operating cash flow per share.
...
- [The Little Book that Builds Wealth by Pat Dorsey](https://blas.com/the-little-book-that-builds-wealth/)
